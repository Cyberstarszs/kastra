...
<div class="card card-modern p-3">
  <form method="post" class="row g-3">
    ...
    <div class="col-12"><label class="form-label">Deskripsi</label><textarea name="deskripsi" class="form-control"><?= h($data['deskripsi']) ?></textarea></div>
    <div class="col-12"><button class="btn btn-utama">Simpan</button> <a href="<?= url('user/transaksi.php') ?>" class="btn btn-light">Kembali</a></div>
  </form>
</div>
